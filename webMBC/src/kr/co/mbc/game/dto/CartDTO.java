...
public class CartDTO {
	...
	// 생성자
	public CartDTO(String name, double weight, double speed, double acceleration, double handling, double friction) {
		super();
		this.name = name;
		this.weight = weight;
		this.speed = speed;
	...
	public String toString() {
		return name + ", 무게=" + weight + ", 속도=" + speed + ", 가속도=" + acceleration + ", 핸들링=" + handling + ", 마찰="
				+ friction + "";
	}
